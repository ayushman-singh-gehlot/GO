...
func writeToChannel(ch chan<- int) { // in this function we can only write on channel
...
func readFromChannel(ch <-chan int) { // in this function we can only read from channel
